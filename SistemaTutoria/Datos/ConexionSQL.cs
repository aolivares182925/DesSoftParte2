...
namespace Datos
{
    public class ConexionSQL
    {
        ...
        //Data Source=tcp:serverproyectotutoria.database.windows.net;Initial Catalog=BD_Tutoria;User ID=admin1;Password=Grupo2DesarrolloSoftware;Application Name=MyApp
